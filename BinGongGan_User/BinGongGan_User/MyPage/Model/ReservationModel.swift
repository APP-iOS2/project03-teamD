...
let reservates: [ReservationModel] = [
    ...
    ReservationModel(placeName: "윤호네", reservationNumber: "A103120145", reservationDate: "9/5 (화) 18:00 ~ 21:00", reservationPersonal: 3, placeAddress: "충청북도 대천군 윤호읍", isReservation: true)
]
