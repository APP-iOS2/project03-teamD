...
struct SellerDetailView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationStack {
            SellerDetailView(seller: Seller(id: "aaa", name: "seller", birthDate: "2000.01.22", phoneNumber: "01011111111", email: "email@email.com", nickname: "IWantMoney", password: "112313", accountNumber: "111111111", registrationNum: "1234567890"))
        }
    }
}
