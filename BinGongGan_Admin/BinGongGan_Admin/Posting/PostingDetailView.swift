...
struct PostingDetailView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationStack {
            PostingDetailView(posting: AdminPoting(place: Place(sellerId: "ssss", placeName: "꽁간", placeCategory: "밴드룸", placeImageStringList: ["https://mblogthumb-phinf.pstatic.net/MjAyMjAzMDFfNDYg/MDAxNjQ2MDk1MDI1OTQy.eu3BCy6F2TpqJfdvCg27njjoRgzPvmYnkpUmVtv8RJsg.BpYYh0MjOT6Gq9i1PrDf213X_mtQ9XR04IEeV4Dk6Lcg.JPEG.awawa11/IMG_9518.jpg?type=w800", "https://mblogthumb-phinf.pstatic.net/MjAyMjAzMDFfMjI5/MDAxNjQ2MDk1MDI0NzI4.CmtFon2i5s_MutSbTq2O1uKTnJyELjx9O8JgOqKXuWYg.0MJCSOGMpVwCaeHF4wgUJD_rXpMNFvjZxIdBA55Qj0Eg.JPEG.awawa11/IMG_9524.jpg?type=w800"], note: ["짱좋음", "애플펀치"], placeInfomationList: ["??", "??"], address: Address(address: "ssss", placeName: "사관 건물", longitude: "222", latitude: "222")), seller: Seller(id: "aaa", name: "seller", birthDate: "2000.01.22", bankName: "01011111111", accountNumber: "email@email.com", phoneNumber: "IWantMoney", email: "112313", nickname: "111111111", password: "1234567890", registrationNum: "", registrationImage: "국민은행"),rooms: [
